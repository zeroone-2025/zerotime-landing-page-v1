...
const features = [
  {
    ...
    title: "통합 조회",
    description:
      "학과 홈페이지, 단과대 사이트, 사업단 공지사항 등 여기저기 흩어져 있는 교내 정보를 ZeroTime 하나로 모았습니다.",
  ...
  },
  {
    ...
    title: "맞춤 필터링",
    description:
      "'장학금', '취업', '특강' 등 원하는 키워드를 등록하거나, 내 전공에 맞는 카테고리만 선택하여 피드를 구성할 수 있습니다.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ZeroTime이 제공하는 세 가지 핵심 기능으로 학교 생활을 더 스마트하게
            관리하세요.
          </p>
        </div>
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-xl`}
              />
            </div>
          ))}
        </div>
